...
solution "planet"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"planet.wasm\"'",
            "-pthread"
        }
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/planet.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && planet -b ../build/planet.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\planet.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./planet -b ../build/planet.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/planet.obr"}
